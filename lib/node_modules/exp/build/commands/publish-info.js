...
exports.default = function (program) {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              if (result.queryResult && result.queryResult.length > 0) {
                ...
                generalTableString = (_cliTable || _load_cliTable()).printTableJson((0, (_extends2 || _load_extends()).default)({
                  fullName: sampleItem.fullName
                }, sampleItem.channel ? { channel: sampleItem.channel } : null), 'General Info');

                console.log(generalTableString);

                // Print info specific to each publication
                headers = ['publicationId', 'appVersion', 'sdkVersion', 'publishedTime', 'platform'];
  ...
  program.command('publish:details [project-dir]').alias('pd').description('View the details of a published release.').option('--publish-id <publish-id>', 'Publication id.').allowNonInteractive().asyncActionProjectDir(function () {
