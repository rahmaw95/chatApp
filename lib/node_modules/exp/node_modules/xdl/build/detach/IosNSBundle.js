...
let _preloadManifestAndBundleAsync = (() => {
  var _ref2 = _asyncToGenerator(function* (manifest, supportingDirectory) {
    ...
    yield (_fsExtra || _load_fsExtra()).default.writeFile(`${supportingDirectory}/shell-app-manifest.json`, JSON.stringify(manifest));
...
let _downloadAssetsAsync = (() => {
  var _ref6 = _asyncToGenerator(function* (assets, dest) {
    const batches = (_lodash || _load_lodash()).default.chunk(assets, 5);
    for (const batch of batches) {
      yield Promise.all(batch.map((() => {
        var _ref7 = _asyncToGenerator(function* (asset) {
          if (!asset.fileHashes) {
            return;
          }

          const downloadTasks = asset.fileHashes.map((() => {
            var _ref8 = _asyncToGenerator(function* (hash) {
              yield (0, (_ExponentTools || _load_ExponentTools()).saveUrlToPathAsync)('https://d1wp6m56sqw74a.cloudfront.net/~assets/' + hash, _path.default.join(dest, hash));
            });
  ...
  return function _downloadAssetsAsync(_x8, _x9) {
...
let configureAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (context) {
    ...
    if (context.data.manifest) {
      const { supportingDirectory } = (_IosWorkspace || _load_IosWorkspace()).getPaths(context);
      yield _downloadAssetsAsync(context.data.manifest.bundledAssets, supportingDirectory);
    }
  ...
  return function configureAsync(_x12) {
